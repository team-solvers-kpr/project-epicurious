        ...
        <div className='lg:flex justify-around lg:px-60 lg:py-10'>
          <div className='p-10'>
            ...
            <div className='flex item-center justify-center p-6 '>
              <div className='flex w-full lg:w-96 rounded border border-2  '>
                <input
                  type={"Search"}
                  name='search'
                  id='search'
            ...
            <div className='hidden lg:block'>
              <div className='flex justify-evenly mb-4'>
                <h5 class='text-lg text-sky-600 font-semibold'>
                  {" "}
                  <a
                    href='https://www.epicurious.com/search'
                    class='hover:underline underline-offset-0   mx-2 p-1   leading-1'
                    target='_blank'
          ...
          <div className='p-10'>
            ...
            <div className='flex  justify-center'>
              <a
                ...
                class='hover:underline underline-offset-0 text-xl text-orange-500 font-semibold mx-2 p-1'
                target='_blank'
                rel='noopener noreferrer'
              >
                CREATE A MENU{" "}
