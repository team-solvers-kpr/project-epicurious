...
const Login = () => {
  ...
  const handleLogin = async (event) => {
    ...
    try{
      await useSignInWithEmailAndPassword(auth).signInWithEmailAndPassword(email, password)
      navigate('/');
    }catch (error){
  ...
  useEffect(() => {
    document.title = 'Login - epicurious'
  }, [])
    ...
    <div className="h-full  mx-auto flex items-center justify-center bg-[#f5f1e7]">
      <div className="max-w-md mx-auto mb-10">
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="input-group flex justify-between border  h-12  ">
                <input
                  ...
                  type="text"
                  onChange={({targer}) => setEmail(targer.value)}
        ...
        <div className="mt-10">
          ...
          <a href="/signin"  className="underline">Sign in with different account</a>
