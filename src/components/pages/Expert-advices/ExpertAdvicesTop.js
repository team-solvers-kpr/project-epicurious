      ...
      <div className="flex-col items-center flex justify-center lg:mx-40 mt-20">
          ...
          <a href="/">
              <div className="flex items-center  justify-center flex-col outline-slate-50  outline-2 outline -outline-offset-[15px]">
                  <div className="">
                      <img src={expertAdvicesTopSingle.cardImg} alt="ingredents images" />
                  </div>
                  <div className="bg-white lg:-mt-24 w-[85%]">
                      <div className="p-6">
                          <h2 className="heading uppercase text-indigo-300">{expertAdvicesTopSingle.cardCategory}</h2>
                          <p className=" title hover:underline text-2xl my-5 text-black font-semibold cursor-pointer pb-2">{expertAdvicesTopSingle.cardHeading}</p>
                          <hr className="mx-96" />
                          <div className="flex justify-center gap-2 pt-4">
                              <h3 className="uppercase text-red-600">{expertAdvicesTopSingle.adviceBy}</h3>
                              <span className="text-indigo-300">/ {expertAdvicesTopSingle.postDate}</span>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div className="flex justify-center flex-wrap mt-4">
              ...
              <div className="p-4 sm:w-1/2 lg:w-1/3">
                  <a href="/" className="h-full border-2 cursor-pointer border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                      <img src={data.cardImg} className="lg:h-72 md:h-48 w-full object-cover object-center" alt="expart-advices card images" />
                      <div className="p-6  transition duration-300 ease-in">
                          ...
                          <p className="leading-relaxed mb-3 text-orange-500">
                              BY {data.adviceBy} / <span className='text-indigo-300'>{data.postDate}</span>
                          </p>
                      </div>
                  </a>
              </div>
