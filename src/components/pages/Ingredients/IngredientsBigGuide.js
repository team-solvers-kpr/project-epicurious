   ...
   return (
      <div className="my-16 relative">
         <div className="flex items-center justify-center relative">
            <Link to={`allEpicuriousData/${bigGuideData[31]._id}`}>
               <img
                  src={bigGuideData[31].img}
         ...
         <div className="grid lg:grid-cols-2 grid-cols-1 divide-x py-8">
            ...
            <div className="lg:pl-10 pl-4 lg:pr-64 pr-4 lg:pt-0 pt-12">
               {bigGuideData.slice(32, 35).map((data) => (
                  <TheBigGuideBottom
                     key={data.id}
                     data={data}
                  ></TheBigGuideBottom>
