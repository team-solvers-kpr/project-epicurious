            ...
            <div className="navbar-start">
                <div className="flex-none">
                    {!isOpen ?
                        ...
                        (
                            <button className="btn btn-ghost text-white text-xl hover:text-rose-600 rounded-full fixed top-4 left-4 z-10" onClick={() => setIsOpen(!isOpen)}>x</button>
                        )
                    }
                    <div className={`top-0 left-0 fixed bg-gray-800 lg:w-[23vw] w-[60vw] h-full ${isOpen ? 'translate-x-0' : '-translate-x-full'} ease-in-out duration-700`}>
                        <div className='my-16'>
