  ...
  return (
    <div className="navbar bg-base-100 border-b-4 border-gray-100 ">
      <div className="navbar-start">
          ...
          >
            ...
            <ul>
              <li className="text-white hover:text-rose-600 font-bold mb-4">
                <a href="/recipies">RECIPIES & MENU</a>
              </li>
              <li className="text-white hover:text-rose-600 font-bold mb-4">
        ...
        <p className="m-2 text-xl text-gray-500 hover:text-gray-700">
          <BsFillHeartFill />
        </p>
      ...
      <div className="navbar-center">
        <Link
          className="cursor-pointer normal-case font-bold text-4xl text-rose-600"
          to="/"
        >
          epicurious
        </Link>
      ...
      <div className="navbar-end">
        ...
        <a
          className="text-2xl text-rose-600 mr-3 hidden lg:block"
