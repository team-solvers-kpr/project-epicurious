...
import bigGuideImg from "../../assets/Images/burger.webp";
      ...
      <div className="my-16 relative">
         ...
         <div className="grid lg:grid-cols-2 grid-cols-1 divide-x py-8">
            <div className="lg:pl-[16rem] pl-10 pr-4">
               <a
                  href="https://www.epicurious.com/recipes-menus/best-brunch-recipes-relaxing-weekend-breakfast-gallery"
                  className="hover:underline cursor-pointer flex lg:text-start text-center text-5xl font-semibold"
               >
                  61 Best Brunch Recipes for a Relaxing Weekend at Home
               </a>
               <p className="text-sm mt-8 lg:text-start text-center">
                  Start your weekend days with something special.
               </p>
            ...
            <div className="pl-10 lg:pr-64 lg:pt-0 pt-12">
               ...
               >
                  ...
                  <p>
                     With This Easy Cake Method, You'll Never Cream Butter and
                     Sugar Together Again
                  </p>
               </a>
               <a
               ...
               >
                  ...
                  <p>
                     This Classic French Cake Tastes Like the World’s Best Candy
                     Bar
                  </p>
               </a>
            </div>
